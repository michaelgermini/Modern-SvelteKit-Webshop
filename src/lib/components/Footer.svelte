  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div class="col-span-1 md:col-span-2">
        <h3 class="text-2xl font-bold text-primary-400 mb-4">🛒 Webshop</h3>
        <p class="text-gray-300 mb-4">
          Your modern online store built with SvelteKit.
          Quality products, secure payment and optimal user experience.
        </p>
      ...
      <div>
        ...
        <ul class="space-y-2">
          ...
          <li><a href="/cart" class="text-gray-300 hover:text-white transition-colors">Cart</a></li>
      ...
      <div>
        ...
        <ul class="space-y-2">
          ...
          <li><a href="/help" class="text-gray-300 hover:text-white transition-colors">Help</a></li>
          <li><a href="/shipping" class="text-gray-300 hover:text-white transition-colors">Shipping</a></li>
    ...
    <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
      <p>&copy; 2024 SvelteKit Webshop. All rights reserved.</p>
    </div>
  </div>
</footer>
